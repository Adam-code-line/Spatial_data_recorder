...
| 产物/字段                                                                        | 说明                                                                                                                                                                                                                                                                                                |
| -------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`data.mov` 视频内容**                                                          | 广角主路：来自 `AVCaptureVideoDataOutput` 的实时帧，经 `AVAssetWriter` 编码为 H.264。为对齐 Spectacular Rec / Spectacular CLI 输入合同，**`data.mov` 保持无音轨**；若需保留音频用于额外处理，建议额外导出 `data_with_audio.mov`（含音轨；录制停止时生成）。 |
